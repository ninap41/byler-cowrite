...
export interface FontFace {
	key: string
	label: string
	/** the CSS font-family stack; empty for the "theme" pseudo-face */
	stack: string
}

export const LOADED_FONTS: readonly FontFace[] = [
...
export const SYSTEM_FONTS: readonly FontFace[] = [
...
export const SITE_FONTS: readonly FontFace[] = [...LOADED_FONTS, ...SYSTEM_FONTS]
export const fontByKey = (key: unknown, list: readonly FontFace[] = SITE_FONTS): FontFace | null => list.find((f) => f.key === key) || null
