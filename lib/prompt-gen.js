...
const PART_KEYS = ["timePeriod", "location", "relationshipContext", "tension", "catalyst", "tone"];
...
export function generateIntermediatePrompt(data, options = {}) {
  ...
  const picked = { timePeriod, location, relationshipContext, tension, tone, catalyst };
...
export function validateIntermediateData(data) {
  ...
  const pools = ["timePeriods", "relationshipContexts", "tones", "locations", "tensions", "catalysts"];
