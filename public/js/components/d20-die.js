...
export const FACES = TRI.map((tri) => {
...
export const NUM = new Array(20).fill(0)
...
export const faceFor = (value) => NUM.indexOf(value)
...
export function paletteRamps(hex) {
...
export function createDie(host, { color = "#e63946", size = 150, reduceMotion } = {}) {
	...
	let tween = null,
		rafId = null
	let settle = null // finishes the roll in flight, if any (see settleNow)
