...
const hudCtlHtml = () => `<span class="gk-hud-ctl"><button type="button" data-hud="min" aria-label="Minimize" title="Minimize to the edge tab">−</button><button type="button" data-hud="close" aria-label="Close" title="Close">×</button></span>`;
